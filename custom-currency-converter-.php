...
function currency_converter_enqueue_scripts() {
    ...
    wp_localize_script('currency-converter-script', 'cc_ajax_object', array('ajax_url' => admin_url('admin-ajax.php')));
}
 ...
 */
include plugin_dir_path(__FILE__) . 'includes/ajax-function.php';
